...
- **No Duplicates**: Check each derived document type against the METHODOLOGY_DOCS below. If the narrative-derived document requests the same class of records as any methodology entry — even if the stated investigative purpose differs — skip it. For example, scene photographs requested by any methodology entry already cover all photographs from the incident regardless of who captured them or what specific details they depict — do not create a separate entry for claimant-taken photographs.
