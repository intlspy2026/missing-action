...
**Signed Authorities XXX**: When filling the XXX placeholder in Signed Authorities, include only authorities actually involved in or referenced in this case. Do not list authorities that have no case involvement. For example: Police only if police attended/investigated; Fire or Emergency Services only if they responded; Medical Records or Hospital only if injuries, hospitalisation, or medical treatment occurred. In an arson case where police and fire brigade responded and no injuries occurred, XXX should be "Police; Other emergency services" — not "Police; Medical Records; Hospital; Other emergency services".
