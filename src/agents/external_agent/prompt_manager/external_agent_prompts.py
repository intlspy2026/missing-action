...
g. Police attendance status — not the mere presence of the word "police" — determines whether a police enquiry is required. Police enquiries are governed exclusively by this rule — RULE 1a through RULE 1f and RULE 1i do not apply. A police enquiry passes the relevance filter if and only if it qualifies under one of the INCLUDE paths below. A loose mention of "police" in any subsection, or a "Police/..." heading with nil content, is NOT positive evidence of involvement. Apply the attendance-status test:
