...
3. For each document type in PREVIOUS VERSION:
    a. Locate the matching entry in the provided GOLD_STANDARDS. Apply RULE 3a: reuse the SME wording verbatim, replacing only AI-fillable placeholders and generic anchors with case-specific values from Step 2. Convert all timeframes in the SME wording into EXACT date ranges anchored to the date of loss identified in Step 2.
