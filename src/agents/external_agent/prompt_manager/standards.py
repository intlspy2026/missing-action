...
- `XXX`, `XXXX`, `XX to XX`, `XXXXXXXXXX` (and similar X-patterns) and other
  generic anchors (`name`, `risk address`, etc.) are filled by the AI at draft
  time from case context.
- `<INSERT PERIOD>` is a user-supplied placeholder — the SME has flagged that
  this slot must be set manually before use; the AI must NOT auto-fill it.
- CAPITALISED tokens inside an otherwise sentence-case entry (e.g. `START/END`)
...
- Signed Authorities: Please sign and return the authority for XXX (attached).
- Claims/Insurance History: A copy of any documents relating to prior insurance/claims made outside of the Suncorp Group for the period <INSERT PERIOD>, including but not limited to; liability assessment, party details, incident description, settlement/repair details, claim outcome, i.e. accepted, declined, withdrawn (if declined, please advise reason), and a copy of any outcome letter.
- Work Roster/Timesheets: A copy of your Work Roster/Timesheet from <INSERT PERIOD> for the period <INSERT PERIOD> - this must include the time you started and ended your shift this day. If you cannot provide a time sheet, you must provide a letter from your Manager with these details.
- Witness Contact Details (Known): Full and complete contact details for <INSERT PERIOD>.
...
- Hospital Records: A copy of documents confirming details of your admission into hospital for the period <INSERT PERIOD>, and any subsequent reports relevant to the claim.
...
- Medical Certificate – Fit to Interview: A signed medical certificate confirming your capacity to participate in an interview.
- Hospital Documents: A copy of documents confirming details of your admission into hospital for the period <INSERT PERIOD>, and any subsequent reports relevant to the claim.
- Prior Insurance Documents: A copy of any documents for prior insurance held for the risk address.
- Tenancy Agreements: A copy of the tenancy agreement for the period <INSERT PERIOD>.
- Signed Authorities: Please sign and return the authority for XXX (attached).
- Police Documents: A copy of documents issued by the Police including but not limited to charge sheet, brief of evidence, court appearance dates and any other document relevant to this matter.
- Court Documents: A copy of the documents issued to you by the Court, including appearance dates, brief of evidence and outcome notices.
- Inspection Reports: A copy of the pre-purchase or pre-existing inspection reports for the risk address conducted between the period XX to XX.
...
- Service, Maintenance and/or Repair Reports: A copy of any receipts, invoices, reports for repairs, maintenance or servicing for <INSERT PERIOD>/the risk address.
