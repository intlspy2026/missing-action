...
- Drivers Licence: A copy of your drivers licence current at the date of loss.
...
- Telephone Records: Fully itemised telephone call and text records for <INSERT PHONE NUMBER> and all numbers held in your or joint names, or which you had access to for the period <INSERT DATE> to <INSERT DATE>. This should be in the original, non-editable format provided by your telephone service provider. For the dates <INSERT DATE>, please fully itemise all calls and texts made listing the party contacted and reason for the call or text.  If you encounter difficulties with your telephone service providers to obtain the above information, please contact the Telecommunications Industry Ombudsman on 1800 062 058 or https://www.tioonline.com.au/consumers/new/.
...
- Toll Statements: A copy of the subject vehicle toll account statements for the date <INSERT DATE> to <INSERT DATE>.
- Photographs of Vehicle: A copy of photographs of the subject vehicle prior to the incident in the original format.
- Photographs of Incident Scene: A copy of any photographs taken at the incident scene including but not limited to; photos of damage to the subject vehicle(s), registration plate(s), and licence(s). Please ensure these photographs are in the original format and size, do not rename the photographs and ensure the photographs are attached to the email as an attachment.
...
- Financial Statements: A copy of your full financial statements (cheque / savings / credit card / loans) for all accounts held in your name, joint-name, or business, or in which you have access to, for the period <INSERT DATE> to <INSERT DATE>. In addition, please complete the financial synopsis attached to the document request letter. (To protect your personal information, please redact/black out the middle 5-6 digits of all account numbers, card number and redact/black out the expiry date and CCV number (if appropriate) of any financial statements provided. For example, 1234 56XX XXXX 7890, Expiry XX/XX, CVV XXX). These documents will assist in support of your version of events and movements and financial position around the time of loss
- Financial Statements (Business): Business Financial Statements for all businesses that you/insert name hold directorships in (including but not limited to <INSERT BUSINESS NAMES> for the period <INSERT DATE> to <INSERT DATE>. This includes bank statements, profit and loss statements and BAS statements.  (To protect your personal information, please redact/black out the middle 5-6 digits of all account numbers, card number and redact/black out the expiry date and CCV number (if appropriate) of any financial statements provided. For example, 1234 56XX XXXX 7890, Expiry XX/XX, CVV XXX).  These documents will assist in support of your version of events and movements and financial position around the time of loss
- MyGov/Centrelink Account Summary: A copy of your MyGov Account Summary, identifying tax assessment information, and/or Centrelink Benefits.
...
- Signed Authorities: Please sign and return the authority for <INSERT AUTHORITY> (attached).
- Claims/Insurance History: A copy of any documents relating to prior insurance/claims made outside of the Suncorp Group for the period <INSERT DATE> to <INSERT DATE>, including but not limited to; liability assessment, party details, incident description, settlement/repair details, claim outcome, i.e. accepted, declined, withdrawn (if declined, please advise reason), and a copy of any outcome letter.
- Work Roster/Timesheets: A copy of your Work Roster/Timesheet from <INSERT EMPLOYER NAME> for the period <INSERT DATE> to <INSERT DATE> - this must include the time you started and ended your shift this day. If you cannot provide a time sheet, you must provide a letter from your Manager with these details.
- Witness Contact Details (Known): Full and complete contact details for <INSERT WITNESS>.
- Witness Contacts Details (Unknown): Full and complete contact details for any party to confirm version of events.
- CCTV Footage: A copy of any CCTV footage for the period <INSERT DATE> to <INSERT DATE>.
...
- Hospital Records: A copy of documents confirming details of your admission into hospital for the period <INSERT DATE> to <INSERT DATE>, and any subsequent reports relevant to the claim.
...
- Prior Insurance Documents (Outside of the Group): A copy of any documents for prior insurance held for the subject vehicle
...
- Rideshare Receipts: A copy of any rideshare receipts for the period <INSERT DATE> to <INSERT DATE>.
- Email/Text Message Correspondence: A copy of any correspondence (emails or text messages) confirming the events date and time.
- Request to Interview: We request that <INSERT NAME> makes themselves available for a recorded interview.
...
- Telephone Records: Fully itemised telephone call and text records for <INSERT NUMBER> and all numbers held in your or joint names, or which you had access to for the period <INSERT DATE> to <INSERT DATE>. This should be in the original, non-editable format provided by your telephone service provider. For the dates <INSERT DATE>, please fully itemise all calls and texts made listing the party contacted and reason for the call or text. If you encounter difficulties with your telephone service providers to obtain the above information, please contact the Telecommunications Industry Ombudsman on 1800 062 058 or https://www.tioonline.com.au/consumers/new/.
...
- Claims/Insurance History: A copy of any documents relating to prior insurance/claims made outside of the Suncorp Group for the period <INSERT DATE> to <INSERT DATE>, including but not limited to; liability assessment, party details, incident description, settlement/repair details, claim outcome, i.e. accepted, declined, withdrawn (if declined, please advise reason), and a copy of any outcome letter.
- Work Roster/Timesheets: A copy of your Work Roster/Timesheet from <INSERT EMPLOYER NAME> for the period <INSERT DATE> to <INSERT DATE> - this must include the time you started and ended your shift this day. If you cannot provide a time sheet, you must provide a letter from your Manager with these details.
- Witness Contact Details (Known): Full and complete contact details for <INSERT NAME>.
- Witness Contacts Details (Unknown): Full and complete contact details for any party to confirm version of events.
- CCTV Footage: A copy of any CCTV footage for the period <INSERT DATE> to <INSERT DATE>.
- Fire Report: A copy of the Fire Report, or Authority to obtain this from the relevant emergency services department.
- Medical Certificate / Fit to Interview: A signed medical certificate confirming your capacity to participate in an interview.
- Hospital Documents: A copy of documents confirming details of your admission into hospital for the period <INSERT DATE> to <INSERT DATE>, and any subsequent reports relevant to the claim.
- Prior Insurance Documents: A copy of any documents for prior insurance held for the risk address.
- Tenancy Agreements: A copy of the tenancy agreement for the period <INSERT DATE> to <INSERT DATE>.
- Signed Authorities: Please sign and return the authority for <INSERT AUTHORITY> (attached).
- Police Documents: A copy of documents issued by the Police including but not limited to charge sheet, brief of evidence, court appearance dates and any other document relevant to this matter.
- Court Documents: A copy of the documents issued to you by the Court, including appearance dates, brief of evidence and outcome notices.
- Inspection Reports: A copy of the pre-purchase or pre-existing inspection reports for the risk address conducted between the period <INSERT DATE> to <INSERT DATE>.
- Evidence of Ownership: A copy of evidence of ownership documents for all items claimed including but not limited to an original receipt for purchase, a valuation certificate from before the loss occurred and a close-up photograph.
...
- Contract of Sale: A copy of the complete and signed final copy of the contract of sale for the risk address.
- Rideshare Receipts: A copy of any rideshare receipts for the period <INSERT DATE> to <INSERT DATE>.
- Mobile Phone Related Documents: A copy of the IDs, serial numbers, IMEI numbers.
- Email/Text Message Correspondence: A copy of any correspondence (emails or text messages) confirming the events date and time.
- Property Manager Correspondence: A copy of any correspondence from the property manager regarding the condition of the property.
- Council Correspondence: A copy of any correspondence from the council regarding the condition of the property.
- Tenant Correspondence: A copy of any correspondence from the tenant regarding the condition of the property.
- Development Application: A copy of any paperwork in relation to the development for the risk address.
...
- Business Records (Business Activity/Use of Property Only): A copy of the relevant business records including BAS Statements, Profit and Loss Statement, Tax Statements for the period <INSERT DATE> to <INSERT DATE>.
