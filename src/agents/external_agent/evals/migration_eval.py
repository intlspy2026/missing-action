...
Compare A and B on the question above. Be specific - cite items in either output that drive your verdict. If neither is meaningfully better, verdict is tie.
"""
        ...
        for _, row in df.iterrows():
            ...
            for section_key in SECTIONS:
                for metric_key in METRICS:
                    ...
                    result: JudgeVerdict = judge.invoke(prompt)
                    verdict_rows.append({
                        "case_id": case_id,
                        "section": section_key,
                        "metric": metric_key,
